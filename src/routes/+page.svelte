    ...
    const features = [
        {
            ...
            description:
                "Interact with presentations elements like text, bullet points, and images!",
            link: "/login",
            newPage: true,
...
<path d="M17.5 9.74145C17.7095 9.53198 18.0491 9.53198 18.2586 9.74145C18.468 9.95092 18.468 10.2905 18.2586 10.5C18.0491 10.7095 17.7095 10.7095 17.5 10.5C17.2905 10.2905 17.2905 9.95092 17.5 9.74145Z" fill="#1C274C"/>`,
        ...
        {
            name: "Relevelent Audio",
            link: "/login",
            description:
                "Replay exact audio segments dirived from your presenter's voice",
            svgContent: `<path
...
<svelte:head>
    <title>LearnX</title>
    <meta name="description" content={"LearnX - description"} />
                    ...
                    >
                        <div class="mockup-browser border">
                            ...
                            <div class="flex justify-center">
                                <!-- TODO: Change mockup-browswer placeholder image -->
                                <img
                                    alt="Screenshot of Yatin's Linkedin"
                ...
                <div class="min-w-[270px] lg:min-w-[420px] flex mt-6 lg:mt-0">
                    <div class="my-auto">
                        <div class="px-4 text-lg md:text-xl">
                            LearnX was created by a college student to help
                            students
                            <span
                                class="underline decoration-secondary decoration-[3px]"
                                >decrease time wasted looking for online
                                resources and study directly given in class
                                content</span
                            >
                        </div>
...
-->
        ...
        >
            {#each features as feature}
                <div
                    class="card bg-base-200 w-[270px] min-h-[300px] flex-none shadow-xl text-base-content"
                >
                    <div
                        class="card-body items-center text-center p-[24px] pt-[32px]"
                    >
                        <div>
                            <svg
                                width="50px"
