<script lang="ts">
    ...
    const planFeatures = [
        ...
        {
            name: "Access to New Features and Tools",
            freeIncluded: false,
            proIncluded: true,
        },
    ];
...
<svelte:head>
    <title>Pricing</title>
    <meta name="description" content="Pricing - LearnX" />
</svelte:head>
...
<div class="min-h-[70vh] pb-8 pt-[5vh] px-4">
    ...
    <h2 class="text-xl text-center text-slate-500 mt-1 pb-3">
        A tool for crammers / studdiers / AI Warriors
    </h2>
    ...
    <div class="w-full my-8">
        ...
        <div class="flex place-content-center">
            <div class="join join-vertical max-w-xl py-6 mx-auto">
                <div
                    class="collapse collapse-arrow join-item border border-primary"
                >
                    <input type="checkbox" name="faq-accordion" />
                    <div class="collapse-title text-lg font-medium">
                        Are there more features coming out?
                    </div>
                    <div class="collapse-content">
                        <p>
                            Yep! I'm planning to provide a variaty of tools for
                            students.
                        </p>
                    </div>
                </div>
                ...
                >
                    <input type="checkbox" name="faq-accordion" />
                    <div class="collapse-title text-lg font-medium">
                        Your FAQ should be longer
                    </div>
                    <div class="collapse-content">
                        <p>
                            Your right, but I have no idea what people would
                            commonly ask lol.
                            <br />
                            This is my first Saas, but many more to come.
                        </p>
                    </div>
                </div>
            </div>
