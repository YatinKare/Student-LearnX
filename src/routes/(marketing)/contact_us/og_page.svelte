    ...
    const handleSubmit = () => {
        ...
        return async ({ update, result }) => {
            ...
            if (result.type === "success") {
                ...
                errors = {
                    _: "An error occurred. Please check inputs and try again.",
                };
            }
        };
    };
...
<div class="flex flex-col lg:flex-row justify-center items-center m-8">
    <div
        class="max-w-[400px] lg:max-w-[400px] flex flex-col place-content-center p-4 lg:mr-8 lg:mb-8 lg:min-h-[70vh]"
    >
        <div class="px-6">
            ...
            <p class="text-sm pt-8">
                *Not really for this demo page, but you should say something
                like that 😉
            </p>
        </div>
    </div>
    ...
    <div
        class="flex flex-col grow m-4 lg:ml-10 stdphone:min-w-[360px] max-w-[400px] place-content-center lg:min-h-[70vh]"
    >
        {#if showSuccess}
        ...
        {:else}
            <div
                class="card card-bordered shadow-lg p-4 pt-6 mx-2 lg:mx-0 lg:p-6"
            >
                <form
                    ...
                    {#each formFields as field}
                        <label for={field.id}>
                            <div class="flex flex-row">
                                ...
                                {#if errors[field.id]}
                                    <div
                                        class="text-red-600 grow text-sm ml-2 text-right"
                                    >
                                        {errors[field.id]}
                                    </div>
                                {/if}
